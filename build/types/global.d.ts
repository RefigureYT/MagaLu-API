 ...
 */
export type MagaluShippingSummary = MagaluShippingBase & Partial<{
 ...
 */
export type MagaluDeliveryStatus = "new" | "approved" | "invoiced" | "shipped" | "delivered" | "cancelled" | "frozen" | (string & {});
/**
